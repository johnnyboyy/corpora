...
subject: coding
posture: guardrail
units-of-work: [debug-issue]
universal: false
---

# Domain: debugging

Judgment about investigating a bug, test failure, or unexpected behavior before proposing or
applying a fix — distinct from `coding-general`/stack-specific coding domains' implementation
judgment and from `testing`'s judgment about what's worth testing at what layer. Seeded 2026-08-02,
mined from `superpowers:systematic-debugging` (its own four-phase structure — root cause
investigation, pattern analysis, hypothesis and testing, implementation — is mechanical and lives
in `processes/debugging.md`; this file is the judgment underneath it). Audit metadata lives in
...
- id: fix-at-source-not-symptom
  ...
  see-also: root-cause-before-fix
...
- id: reproduce-as-failing-test-before-fixing
  ...
  see-also: testing/runtime-verification-required-not-static-checks-alone
