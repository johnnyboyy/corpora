...
Warnings, validation, and surfacing side effects. Cross-role — declared by both the **ux-designer**
and **ui-designer** lenses (the UX locates the fix; the UI co-locates it visually). Provenance and
