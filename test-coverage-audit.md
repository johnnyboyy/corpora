...
description: Assess how well the test suite covers the application's actual, observable behavior. Produces a list of gaps, not tests — see integration-test-implementation.md for execution. Composition is ordinary implement-feature — the judgment is domains/testing.md.
---
...
routine test-writing alongside a feature — that's `test-writing-at-implementation.md`'s concern.
...
4. Do not write the tests in this phase — an audit that also implements blurs "what's missing" with
   ...
   list to `integration-test-implementation.md`.
